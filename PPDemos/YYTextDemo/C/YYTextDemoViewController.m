...
-(void)test002
{
    ...
    [lb pp_attributedWithText:lb.text font:@15 kern:1 textColor:[UIColor purpleColor] lineSpacing:4 textAligent:NSTextAlignmentCenter specialText:@"技能" specialTextFont:@18 specialTextColor:[UIColor pp_skyBlueColor]];
...
-(void)test001
{
    ...
    NSMutableAttributedString *mutStr = [NSMutableAttributedString pp_attributedStringWithText:@"bobo" font:@10 kern:4 textColor:[UIColor pp_blueColor] lineSpacing:14 textAligent:NSTextAlignmentCenter];
    ...
    [_topLB pp_attributedWithText:textStr font:@18 kern:4 textColor:[UIColor pp_purpleColor] lineSpacing:8 textAligent:NSTextAlignmentCenter specialTextArray:@[@"山",@"花"] specialTextFontArray:@[[UIFont systemFontOfSize:12],[UIFont systemFontOfSize:20],[UIFont systemFontOfSize:18]] specialTextColorArray:@[[UIColor pp_redColor],[UIColor pp_blueColor]]];
