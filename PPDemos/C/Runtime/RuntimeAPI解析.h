...
#ifndef RuntimeAPI___h
#define RuntimeAPI___h
/*
 ...
 *
 * 开源性
 * the Apple Public Source License Version 2.0 (the 'License')
 *
...
struct objc_class {
    Class isa  OBJC_ISA_AVAILABILITY; //在Object-C中，Object本质上是一个struct，在这个struct中会保存一个名为isa的指针，该指针会指向该Object的类。
 ...
 *   NSString *ppStr = @"ppdemos";
     BOOL isStr = object_isClass([ppStr class]);  //YES
 */
