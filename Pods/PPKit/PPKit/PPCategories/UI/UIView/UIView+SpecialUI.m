...
/** 【(用imgV)创建一个线】 父视图 图片名  */
+(UIImageView *)pp_lineDashedWithSuperV:(UIView *)superV
...
+(UIImageView *)pp_lineDashedWithSuperV:(UIView *)superV
                              ...
                              lineFrame:(CGRect)lineFrame
{
    UIImageView *imgV = [self pp_lineDashedWithSuperV:superV imgName:imgName];
    imgV.frame = lineFrame;
    return imgV;
}

/** 【用CAShapeLayer创建一根线】 父视图 可见的一小段线的宽度 线段间距 线颜色 */
+(UIView *)pp_lineDashedByCAShapeLayerWithSuperV:(UIView *)superV
