                               ...
                               textAligent:(NSTextAlignment)textAligent
{
    ...
    [UIFont pp_fontSetWithSpecifiedFontStr:font forAttributedStr:attributedStr];
    [UIColor pp_colorSetWithTextColor:textColor forAttributedStr:attributedStr];
                          ...
                          specialTextColor:(UIColor *)specialTextColor
{
    ...
    //特殊字符【字体】配置
    [UIFont pp_fontSetWithSpecifiedFontStr:font forAttributedStr:attributedStr specailText:specialText];
    //特殊字符【颜色配置】
    [UIColor pp_colorSetWithSpecialTextColor:textColor forAttributedStr:attributedStr specialText:specialText];
    return attributedStr;
}
        ...
        for (int i = 0; i<specialTextArray.count; i++) {
            ...
            for (int j = 0; j<resultArrs.count; j++) {
                ...
                if (specialTextFontArray.count > i) {
                    NSString *aFont = specialTextFontArray[i];
                    [UIFont pp_fontSetWithSpecifiedFontStr:aFont forAttributedStr:attributedStr specailText:aSpecialStr];                }
            }
